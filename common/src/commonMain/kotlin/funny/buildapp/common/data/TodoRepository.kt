...
public class TodoRepository {
    public fun getAll(todo: Todos): Unit = database.todoQueries.insert(todo)
    ...
    public fun selectById(id: Long): List<Todos> = database.todoQueries.selectById(id).executeAsList()
